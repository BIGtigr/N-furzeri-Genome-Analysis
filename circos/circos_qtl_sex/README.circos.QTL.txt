1. <Karyotype.Killifish.LG.txt> is the file I manually prepared from the QTL data. It has the length i terms of cM for each
   scaffold. I use it as my coordinate systm to plot circos. The file used to prepare this is <qtl_files/go32014_all_pos_procesed.txt.txt>
   This file has all the markers including the ones that map on LG. I am using this for both sex and survival QTL.

2. Get Q-values and their rounded position on circos to plot

   SCRIPT: *1_getQvalues_Sex.pl*
   OUTPUT: <sexQvals.txt>
